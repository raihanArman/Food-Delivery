package com.randev.food_delivery.screen.sign_up
...
fun SignUpProcessScreen() {
    Box(
        ...
        Column(
            ...
            TextFieldCustom(text = "", onTextChanged = {}, hintText = "First name")
            TextFieldCustom(text = "", onTextChanged = {}, hintText = "Last name")
            TextFieldCustom(text = "", onTextChanged = {}, hintText = "Mobile number")
